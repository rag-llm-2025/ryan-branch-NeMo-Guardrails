...
## 或者测试API端点是否可达
curl http://gn401.crg.cerence.net:8010/v1/models

## 检查网络连接是否正常：
```
ping gn401.crg.cerence.net
telnet gn401.crg.cerence.net 8010
nslook gn401.crg.cerence.net
```
...
# 环境变量
```
cluster: export HOST=10.16.118.41
docker: export HOST=gn401.crg.cerence.net
export PORT=8010
